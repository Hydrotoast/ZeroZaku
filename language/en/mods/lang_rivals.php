...
$lang	= array_merge ( $lang, array (
	...
	'INSTALLER_COMPLETE'			=> 'phpBB Rivals installation is now complete. Be sure to read and follow the instructions found in install.xml to make the proper file changes to your phpBB core. You may now delete the install directory.
<br /><br />
Thank you for choosing phpBB Rivals,
A.I. BOT',
	...
	'INSTALLER_MF'					=> 'One or more modules failed to install. Please remove any phpBB Rivals modules from your phpBB ACP.',
...
[url=%s%s%s/rivals.php?action=group_profile&amp;clan_id=%s]%s[/url] has sent a ticket.
...
[b][url=%s%s%s/rivals.php?action=group_profile&clan_id=%s]%s[/url][/b] (P: %s, L: %s, S: %s) has issued you a challenge. Please login to your Clan CP and either accept or decline the challenge when ready.

Do not reply to this username,
Thank you.',
	'PM_CHALLENGETXT2'				=> 'This is an automated message from the system.

[b][url=%s%s%s/rivals.php?action=group_profile&clan_id=%s]%s[/url][/b] (P: %s, L: %s, S: %s) has issued you a [b]unranked[/b] challenge. Please login to your Clan CP and either accept or decline the challenge when ready.
...
Information: %s',
	...
	'WELCOME_RIVALS'				=> 'Welcome to phpBB Rivals',
	'WELCOME_RIVALSTXT'				=> 'Thank you for choosing phpBB Rivals for your gaming solution. This screen will give you a quick overview of various statistics. Use the links on the left to control the aspects of your phpBB Rivals experience.',
	'WIN'							=> 'Win',
	'WINNER'						=> 'Winner',
