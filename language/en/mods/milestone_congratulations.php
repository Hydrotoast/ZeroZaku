...
$lang = array_merge($lang, array(
	'MILESTONE_TITLE'	=> 'Dominance War',
	'MILESTONE_ERROR'	=> 'Install and run Administration Control Panel module first!',

	// ACP
	'MC_SETTING'		=> 'Functionality',
	'MC_SETTING_EXP'	=> 'Dominations to be displayed on index and history pages. History of <strong>all counters</strong> will <strong>always</strong> be kept!',
	...
	'MC_INC_EXP'		=> 'Upon reaching the current domination the counter is automatically incremented by this amount.',
	...
	'MILESTONES'		=> 'Dominations',
	'MILESTONE_HISTORY'	=> 'Dominance War',
...
/***	Only do this once posts, topics and users milestones go beyond 3 (because of the English language's 1st, 2nd, 3rd)!
	...
	// Viewonline
	'VIEWING_MILESTONES'	=> 'Viewing Dominance War page'
));
