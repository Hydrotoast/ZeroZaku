...
if ($post_id)
{
	...
	if ($report_data['post_reported'])
	{
		...
		$message .= '<br />' . sprintf($user->lang['RETURN_TOPIC'], '<a href="' . $redirect_url . '">', '</a>');
...
else
{
	...
	if ($report_data['message_reported'])
	{
		...
		$message .= '<br />' . sprintf($user->lang['RETURN_PM'], '<a href="' . $redirect_url . '">', '</a>');
		trigger_error($message);
	}
}
...
if ($submit && $reason_id)
{
	...
	$message = $lang_success . '<br />' . sprintf($lang_return, '<a href="' . $redirect_url . '">', '</a>');
	trigger_error($message);
}
