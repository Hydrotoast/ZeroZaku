...
* @version $Id: acp_portal.php 468 2009-02-13 21:01:41Z Christian_N $
...
class acp_portal
{
	...
	function main($id, $mode)
	{
		...
		*/
		...
		$title_explain .= ( $display_vars['title'] == 'ACP_PORTAL_GENERAL_TITLE' ) ? '<br />' . sprintf($user->lang['ACP_PORTAL_VERSION'], $portal_config['portal_version']) : '';
