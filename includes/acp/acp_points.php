...
* @version $Id: acp_points.php 587 2009-10-14 18:36:12Z Wuerzi $
		...
		switch ( $mode ) 
		{
			...
			case 'lottery':
				...
				if ( $submit )
				{
					...
					set_points_values('lottery_name', ("'" . $lottery_name . "'"));
			...
			case 'bank':
				...
				if ( $submit )
				{
					...
					set_points_values('bank_name', ("'" . $bank_name . "'"));
