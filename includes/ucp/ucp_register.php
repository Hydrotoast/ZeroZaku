...
class ucp_register
{
	...
	function main($id, $mode)
	{
		...
		if ($submit == true && (!isset($_POST['gender']) || ($_POST['gender'] != "M" && $_POST['gender'] != "F"))) {trigger_error("Ad Robot used REGISTER.<br/>Ad Robot's attack missed!<br />ZeroZaku used BOTSTOPPER.<br />It was super effective!<br />Enemy Ad Robot Fainted!<br />ZeroZaku gained 9001 EXP!"); }
