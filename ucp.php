...
switch ($mode)
{
	...
	case 'logout':
		...
		$message = $message . '<br />' . sprintf($user->lang['RETURN_INDEX'], '<a href="' . append_sid("{$phpbb_root_path}index.$phpEx") . '">', '</a> ');
	...
	case 'delete_cookies':
		...
		if (confirm_box(true))
		{
			...
			$message = $user->lang['COOKIES_DELETED'] . '<br />' . sprintf($user->lang['RETURN_INDEX'], '<a href="' . append_sid("{$phpbb_root_path}index.$phpEx") . '">', '</a>');
			trigger_error($message);
		}
		else
		{
	...
	case 'switch_perm':
		...
		$message = sprintf($user->lang['PERMISSIONS_TRANSFERRED'], $user_row['username']) . '<br />' . sprintf($user->lang['RETURN_INDEX'], '<a href="' . append_sid("{$phpbb_root_path}index.$phpEx") . '">', '</a>');
		trigger_error($message);
	...
	case 'restore_perm':
		...
		$message = $user->lang['PERMISSIONS_RESTORED'] . '<br />' . sprintf($user->lang['RETURN_INDEX'], '<a href="' . append_sid("{$phpbb_root_path}index.$phpEx") . '">', '</a>');
		trigger_error($message);
