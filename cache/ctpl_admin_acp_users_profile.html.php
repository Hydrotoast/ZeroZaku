...
<fieldset><legend><?php echo ((isset($this->_rootref['L_USER_PROFILE'])) ? $this->_rootref['L_USER_PROFILE'] : ((isset($user->lang['USER_PROFILE'])) ? $user->lang['USER_PROFILE'] : '{ USER_PROFILE }')); ?></legend>
<dl>
...
<dl>
	...
	<dd><input type="text" id="website" name="website"
		value="<?php echo (isset($this->_rootref['WEBSITE'])) ? $this->_rootref['WEBSITE'] : ''; ?>" /></dd>
</dl>
<dl>
	...
	<dd><input type="text" id="location" name="location"
		value="<?php echo (isset($this->_rootref['LOCATION'])) ? $this->_rootref['LOCATION'] : ''; ?>" /></dd>
</dl>
<dl>
...
<dl>
	...
	<dd><?php echo ((isset($this->_rootref['L_DAY'])) ? $this->_rootref['L_DAY'] : ((isset($user->lang['DAY'])) ? $user->lang['DAY'] : '{ DAY }')); ?>: <select id="birthday" name="bday_day">
		<?php echo (isset($this->_rootref['S_BIRTHDAY_DAY_OPTIONS'])) ? $this->_rootref['S_BIRTHDAY_DAY_OPTIONS'] : ''; ?>
	</select> <?php echo ((isset($this->_rootref['L_MONTH'])) ? $this->_rootref['L_MONTH'] : ((isset($user->lang['MONTH'])) ? $user->lang['MONTH'] : '{ MONTH }')); ?>: <select name="bday_month">
		<?php echo (isset($this->_rootref['S_BIRTHDAY_MONTH_OPTIONS'])) ? $this->_rootref['S_BIRTHDAY_MONTH_OPTIONS'] : ''; ?>
	</select> <?php echo ((isset($this->_rootref['L_YEAR'])) ? $this->_rootref['L_YEAR'] : ((isset($user->lang['YEAR'])) ? $user->lang['YEAR'] : '{ YEAR }')); ?>: <select name="bday_year">
		<?php echo (isset($this->_rootref['S_BIRTHDAY_YEAR_OPTIONS'])) ? $this->_rootref['S_BIRTHDAY_YEAR_OPTIONS'] : ''; ?>
	</select></dd>
</dl>
</fieldset>

<?php if (sizeof($this->_tpldata['profile_fields'])) {  ?>
<fieldset><legend><?php echo ((isset($this->_rootref['L_USER_CUSTOM_PROFILE_FIELDS'])) ? $this->_rootref['L_USER_CUSTOM_PROFILE_FIELDS'] : ((isset($user->lang['USER_CUSTOM_PROFILE_FIELDS'])) ? $user->lang['USER_CUSTOM_PROFILE_FIELDS'] : '{ USER_CUSTOM_PROFILE_FIELDS }')); ?></legend> <?php $_profile_fields_count = (isset($this->_tpldata['profile_fields'])) ? sizeof($this->_tpldata['profile_fields']) : 0;if ($_profile_fields_count) {for ($_profile_fields_i = 0; $_profile_fields_i < $_profile_fields_count; ++$_profile_fields_i){$_profile_fields_val = &$this->_tpldata['profile_fields'][$_profile_fields_i]; ?>
<dl>
	<dt><label<?php if ($_profile_fields_val['FIELD_ID']) {  ?>
	for="<?php echo $_profile_fields_val['FIELD_ID']; ?>"<?php } ?>><?php echo $_profile_fields_val['LANG_NAME']; ?>:</label><?php if ($_profile_fields_val['LANG_EXPLAIN']) {  ?><br />
