<?php if (!defined('IN_PHPBB')) exit; ?><h2 id="review" class="pagetitle">
	...
	<span><?php echo ((isset($this->_rootref['L_TOPIC_REVIEW'])) ? $this->_rootref['L_TOPIC_REVIEW'] : ((isset($user->lang['TOPIC_REVIEW'])) ? $user->lang['TOPIC_REVIEW'] : '{ TOPIC_REVIEW }')); ?>: <?php echo (isset($this->_rootref['TOPIC_TITLE'])) ? $this->_rootref['TOPIC_TITLE'] : ''; ?></span>
</h2>
...
<div id="topicreview">
	...
	<?php } ?>
		...
		<div id="pr<?php echo $_topic_review_row_val['POST_ID']; ?>">
			<div class="postmeta">
				<div class="dropdown">
					<span class="username"><?php echo $_topic_review_row_val['POST_AUTHOR_FULL']; ?></span>
				</div>
				<span class="date"><?php echo $_topic_review_row_val['POST_DATE']; ?> <a href="<?php echo $_topic_review_row_val['U_MINI_POST']; ?>" title="<?php echo ((isset($this->_rootref['L_PERMALINK'])) ? $this->_rootref['L_PERMALINK'] : ((isset($user->lang['PERMALINK'])) ? $user->lang['PERMALINK'] : '{ PERMALINK }')); ?> to post #<?php echo $_topic_review_row_val['POST_ID']; ?>"><?php echo $_topic_review_row_val['MINI_POST_IMG']; echo $_topic_review_row_val['POST_ID']; ?></a></span>
			</div>
			...
			<ul class="profile-icons">
				<?php if ($_topic_review_row_val['POSTER_QUOTE'] && $_topic_review_row_val['DECODED_MESSAGE']) {  ?><li class="quote-icon"><a href="#postingbox" onclick="addquote(<?php echo $_topic_review_row_val['POST_ID']; ?>, '<?php echo $_topic_review_row_val['POSTER_QUOTE']; ?>');" title="<?php echo ((isset($this->_rootref['L_QUOTE'])) ? $this->_rootref['L_QUOTE'] : ((isset($user->lang['QUOTE'])) ? $user->lang['QUOTE'] : '{ QUOTE }')); ?> <?php echo $_topic_review_row_val['POST_AUTHOR']; ?>"><span><?php echo ((isset($this->_rootref['L_QUOTE'])) ? $this->_rootref['L_QUOTE'] : ((isset($user->lang['QUOTE'])) ? $user->lang['QUOTE'] : '{ QUOTE }')); ?> <?php echo $_topic_review_row_val['POST_AUTHOR']; ?></span></a></li><?php } if ($_topic_review_row_val['U_MCP_DETAILS']) {  ?><li><a href="<?php echo $_topic_review_row_val['U_MCP_DETAILS']; ?>"><?php echo ((isset($this->_rootref['L_POST_DETAILS'])) ? $this->_rootref['L_POST_DETAILS'] : ((isset($user->lang['POST_DETAILS'])) ? $user->lang['POST_DETAILS'] : '{ POST_DETAILS }')); ?></a></li><?php } ?>
