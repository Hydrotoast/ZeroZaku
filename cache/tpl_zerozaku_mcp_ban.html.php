...
<div class="panel">
	...
	<h3 class="sub"><?php echo ((isset($this->_rootref['L_TITLE'])) ? $this->_rootref['L_TITLE'] : ((isset($user->lang['TITLE'])) ? $user->lang['TITLE'] : '{ TITLE }')); ?></h3>
...
<div class="panel">
	...
	<h3 class="sub"><?php echo ((isset($this->_rootref['L_UNBAN_TITLE'])) ? $this->_rootref['L_UNBAN_TITLE'] : ((isset($user->lang['UNBAN_TITLE'])) ? $user->lang['UNBAN_TITLE'] : '{ UNBAN_TITLE }')); ?></h3>
