...
<div id="topicreview">
	...
	<div class="post bg1">
		...
		<div class="postmeta">
			<div class="dropdown">
				<span><?php echo $_history_row_val['MESSAGE_AUTHOR_FULL']; ?></span>
			</div>
			<span class="date"><?php echo $_history_row_val['SENT_DATE']; ?></span>
		</div>

		<div class="postbody" id="pr<?php echo $_history_row_val['MSG_ID']; ?>">
			<h3 class="sub"><a href="<?php echo $_history_row_val['U_VIEW_MESSAGE']; ?>" <?php if ($_history_row_val['S_CURRENT_MSG']) {  ?>class="current"<?php } ?>><?php echo $_history_row_val['SUBJECT']; ?></a></h3>
