<?php if (!defined('IN_PHPBB')) exit; $this->_tpldata['DEFINE']['.']['CA_PAGE'] = 'viewtopic'; $this->_tpl_include('overall_header.html'); $this->_tpl_include('portal/_block_config.html'); $this->_tpl_include('quickedit.html'); ?><!-- NOTE: remove the style="display: none" when you want to have the forum description on the topic body --><?php if ($this->_rootref['FORUM_DESC']) {  ?><div class="panel info"><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/info.png" alt="Information" /><p><?php echo (isset($this->_rootref['FORUM_DESC'])) ? $this->_rootref['FORUM_DESC'] : ''; ?></p></div><?php } if ($this->_rootref['MODERATORS'] || $this->_rootref['U_MCP']) {  ?>
