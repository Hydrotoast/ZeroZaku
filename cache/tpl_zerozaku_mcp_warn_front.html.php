...
<div class="panel">
	...
	<h3 class="sub"><?php echo ((isset($this->_rootref['L_SELECT_USER'])) ? $this->_rootref['L_SELECT_USER'] : ((isset($user->lang['SELECT_USER'])) ? $user->lang['SELECT_USER'] : '{ SELECT_USER }')); ?></h3>
...
<div class="panel">
	...
	<h3 class="sub"><?php echo ((isset($this->_rootref['L_MOST_WARNINGS'])) ? $this->_rootref['L_MOST_WARNINGS'] : ((isset($user->lang['MOST_WARNINGS'])) ? $user->lang['MOST_WARNINGS'] : '{ MOST_WARNINGS }')); ?></h3>
...
<div class="panel">
	...
	<h3 class="sub"><?php echo ((isset($this->_rootref['L_LATEST_WARNINGS'])) ? $this->_rootref['L_LATEST_WARNINGS'] : ((isset($user->lang['LATEST_WARNINGS'])) ? $user->lang['LATEST_WARNINGS'] : '{ LATEST_WARNINGS }')); ?></h3>
