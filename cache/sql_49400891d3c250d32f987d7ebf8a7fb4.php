...
a:1:{i:0;a:11:{s:8:"style_id";s:1:"4";s:8:"theme_id";s:1:"5";s:10:"theme_data";s:100726:"/*  phpBB 3.0 Style Sheet
	...
	Copyright 2009, 2010 ZeroZaku ( http://www.zerozaku.com/ )
    --------------------------------------------------------------
*/
...
@font-face {
	...
	src: url('/type/anivers_regular-webfont.woff') format('woff'), url('/type/anivers_regular-webfont.ttf') format('truetype'), url('/type/anivers_regular-webfont.svg#webfontxD9Wa0Mc') format('svg');
	font-weight: normal;
	font-style: normal;
}
...
#board-statistics {
	...
	#board-statistics .stats dl {
		margin: 4px 0 10px;
	}
	
	#board-statistics .stats dt {
		text-align: left;
		float: right;
		padding: 0.25em;
		width: 33.3333%;
...
h2.pro-header, h3.pro-header {
	...
	text-transform: uppercase;
	border-bottom: 1px solid;
	margin: 0 -20px 4px -20px; /* Negative margins */
	padding: 4px 20px;
}
...
ul.topiclist li.row.bg1, ul.topiclist li.row.bg2 {
	border-bottom: 1px solid;
}
...
.forabg-sidebar.smooth {
	padding: 1px;
}

.forabg-sidebar.smooth ul.topiclist {
...
.panel.tag .infotitle {
	font: normal 2em Anivers-Regular, Arial, Helvetica, sans-serif;
	text-transform: none;
	margin: 12px 0 0 67px;
	padding: 0;
}

.panel.info img, .panel.tag img {
	float: left;
	margin: 6px 0;
}
...
#format-buttons select, #mChatBBCodes select {
	margin-right: -4px;
	height: 25px;
}

#format-buttons input:first-child, #mChatBBCodes input:first-child {
...
#format-buttons input:last-child, #mChatBBCodes input:last-child {
...
#cp-main .meta dt, #cp-main .meta dd {
	padding: 4px 0;
}
...
input#add_keywords {
	background: transparent url("{T_THEME_PATH}/images/search_bg.png") no-repeat;
	border: 0;
	height: 15px;
	width: 132px;
	padding: 6px 8px 4px 26px;
...
#site-bottom-bar {
	background: #E0E0E0 url("{T_THEME_PATH}/images/button_bg4.gif") repeat-x scroll 0 0;
	border: solid #999999;
	border-width: 1px 1px 0 1px;
	z-index: 100;
	height: 25px;
...
#board-statistics .stats { border-color: #D0D0D0; }
#board-statistics .stats dd {border-color: #D0D0D0; }
...
#search-box #keywords { background: transparent url("{T_THEME_PATH}/images/search_bg.png") no-repeat; }
...
--------------------------------------------- */
.breadcrumbs {
	background: #EEEEEE url("{T_THEME_PATH}/images/meta_bg.gif") repeat-x scroll;
	border-bottom-color: #C0C0C0;
	color: #212121;
}

.breadcrumbs .navlinks .icon-home a.index:link, .breadcrumbs .navlinks .icon-home a.index:visited { color: #666666; }
.breadcrumbs .navlinks .icon-home a.index:hover, .breadcrumbs .navlinks .icon-home a.index:active { color: #FF0000; }
...
.breadcrumbs .navlinks .icon-home a:hover, .breadcrumbs .navlinks .icon-home a:active { color: #FF0000; }
	...
	/* Account actions box
	--------------------------------------------- */
	#account-actions li a:link, #account-actions li a:visited { color: #666666; }
...
.navbar a:hover span, .navbar a:active span { color: #606060; }
.navbar span { color: #C0C0C0; }
...
---------------------------------------- */
h2.pro-header, h3.pro-header {
	background: url("{T_THEME_PATH}/images/button_bg4.gif") repeat-x scroll 0 0 #E0E0E0;
	border-color: #C0C0C0;
	color: #666666;
}
...
.panel h3.head { color: #999999; }
.panel h3.sub { color: #606060; }
...
.panel.info .infotitle, .panel.tag .infotitle { color: #999999; }
.panel.info p, .panel.tag p { color: #666666; }

.panel .login { border-right-color: #D0D0D0; }
.login-box {border-color: #C0C0C0;}
...
table#recent .meta th {
	font-weight: bold;
	background: #EEEEEE url("{T_THEME_PATH}/images/meta_bg.gif") repeat-x;
	border-bottom-color: #C0C0C0;
	color: #212121;
}
...
.pagination span a, .pagination span a:link, .pagination span a:visited, .pagination span a:active {
	background: #D0D0D0 url({T_THEME_PATH}/images/button_bg4.gif) repeat-x scroll 0 -1px;
	color: #666666;
	border-color: #BBBBBB;
}
...
a.forumtitle {color: #212121;}
/* a.forumtitle:visited { color: #2D587E; } */
a.forumtitle:hover {color: #FF0000;}
a.forumtitle:active {color: #2D587E;}

a.topictitle, a.topictitle h3 { color: #212121; }
a.topictitle:hover, a.topictitle:active, a.topictitle:hover h3, a.topictitle:active h3 { color: #FF0000 }
...
ul.profile-icons li a {
	background: #D0D0D0 url("{T_THEME_PATH}/images/button_bg4.gif") scroll repeat-x 0 -2px;
...
ul.profile-icons li a:hover, ul.profile-icons li a:active {
	border-color: #606060;
	-moz-box-shadow: 0 0 3px #606060;
	-webkit-box-shadow: 0 0 3px #606060;
	box-shadow: 0 0 3px #606060;
...
ul.topiclist dl.meta dt, ul.topiclist dl.meta dd {
	background: #EEEEEE url("{T_THEME_PATH}/images/meta_bg.gif") repeat-x;
	color: #212121;
}

ul.topiclist dl.meta dd {
...
ul.topiclist li.row.bg1, ul.topiclist li.row.bg2 { border-bottom-color: #F0F0F0; }
...
h1.topictitle, h3.solo {
	background: #000000 url("{T_THEME_PATH}/images/gradient_bg3.gif") repeat-x scroll;
	color: #FFFFFF;
}

h1.topictitle a, h2.cattitle a, .forabg li.header span, .forumbg li.header span, h2.pagetitle span, h2.cattitle span {
...
h2.pagetitle {
	background: #E0E0E0 url("{T_THEME_PATH}/images/button_bg4.gif") repeat-x scroll;
	border-color: #E0E0E0;
}
...
input.button1 {
	background: #212121 url("{T_THEME_PATH}/images/button3_bg.gif") repeat-x scroll 0 -1px !important;
	color: #FFFFFF;
}
...
input.button3, a.button2, input.button2 { background: #E0E0E0 url("{T_THEME_PATH}/images/button_bg4.gif") repeat-x scroll; }
...
input.search { background: transparent url("{T_THEME_PATH}/images/search_bg.png") no-repeat; }
...
/* CSS Dropdown */
.dropdown > span {
	background: #E0E0E0 url("{T_THEME_PATH}/images/button_bg4.gif") scroll repeat-x;
