...
<div class="panel login content_center">
	<div class="inner">
		<?php if (! $this->_rootref['S_ADMIN_AUTH']) {  ?>
			...
			<div class="login-box">
				<h3 class="head"><?php if ($this->_rootref['LOGIN_EXPLAIN']) {  echo (isset($this->_rootref['LOGIN_EXPLAIN'])) ? $this->_rootref['LOGIN_EXPLAIN'] : ''; } else { echo ((isset($this->_rootref['L_LOGIN_PAGE_TITLE'])) ? $this->_rootref['L_LOGIN_PAGE_TITLE'] : ((isset($user->lang['LOGIN_PAGE_TITLE'])) ? $user->lang['LOGIN_PAGE_TITLE'] : '{ LOGIN_PAGE_TITLE }')); } ?></h3>
			...
			<div class="signup">
				<h3 class="head"><?php echo ((isset($this->_rootref['L_REGISTER_PAGE_TITLE'])) ? $this->_rootref['L_REGISTER_PAGE_TITLE'] : ((isset($user->lang['REGISTER_PAGE_TITLE'])) ? $user->lang['REGISTER_PAGE_TITLE'] : '{ REGISTER_PAGE_TITLE }')); ?></h3>
				...
				<h4><?php echo ((isset($this->_rootref['L_LOGIN_INFO'])) ? $this->_rootref['L_LOGIN_INFO'] : ((isset($user->lang['LOGIN_INFO'])) ? $user->lang['LOGIN_INFO'] : '{ LOGIN_INFO }')); ?></h4><br />
				<?php echo ((isset($this->_rootref['L_REGISTER_PAGE_INCENTIVE'])) ? $this->_rootref['L_REGISTER_PAGE_INCENTIVE'] : ((isset($user->lang['REGISTER_PAGE_INCENTIVE'])) ? $user->lang['REGISTER_PAGE_INCENTIVE'] : '{ REGISTER_PAGE_INCENTIVE }')); ?>
