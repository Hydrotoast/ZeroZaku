...
<div class="panel">
	...
	<?php } if ($this->_rootref['S_CAN_HIDE_REPUTATION']) {  ?>
		...
		<dl>
			<dt><label for="hideonline0"><?php echo ((isset($this->_rootref['L_RP_HIDE'])) ? $this->_rootref['L_RP_HIDE'] : ((isset($user->lang['RP_HIDE'])) ? $user->lang['RP_HIDE'] : '{ RP_HIDE }')); ?>:</label></dt>
			<dd>
				<label for="hidereputation1"><input type="radio" name="hidereputation" id="hidereputation1" value="1"<?php if ($this->_rootref['S_HIDE_REPUTATION']) {  ?> checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></label>
				<label for="hidereputation0"><input type="radio" name="hidereputation" id="hidereputation0" value="0"<?php if (! $this->_rootref['S_HIDE_REPUTATION']) {  ?> checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></label>
			</dd>
		</dl>
	...
	<h3 class="sub"><?php echo ((isset($this->_rootref['L_COMMENT_PRIV'])) ? $this->_rootref['L_COMMENT_PRIV'] : ((isset($user->lang['COMMENT_PRIV'])) ? $user->lang['COMMENT_PRIV'] : '{ COMMENT_PRIV }')); ?></h3>
	<dl>
		<dt><label for="allow_all_comment0"><?php echo ((isset($this->_rootref['L_ALLOW_ALL_COMMENT'])) ? $this->_rootref['L_ALLOW_ALL_COMMENT'] : ((isset($user->lang['ALLOW_ALL_COMMENT'])) ? $user->lang['ALLOW_ALL_COMMENT'] : '{ ALLOW_ALL_COMMENT }')); ?>:</label><br /><span><?php echo ((isset($this->_rootref['L_ALLOW_ALL_COMMENT_EXPLAIN'])) ? $this->_rootref['L_ALLOW_ALL_COMMENT_EXPLAIN'] : ((isset($user->lang['ALLOW_ALL_COMMENT_EXPLAIN'])) ? $user->lang['ALLOW_ALL_COMMENT_EXPLAIN'] : '{ ALLOW_ALL_COMMENT_EXPLAIN }')); ?></span></dt>
		<dd>
			<label for="allow_all_comment1"><input type="radio" name="allow_all_comment" id="allow_all_comment1" value="1"<?php if ($this->_rootref['S_ALLOW_ALL_COMMENT']) {  ?> checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></label> 
			<label for="allow_all_comment0"><input type="radio" name="allow_all_comment" id="allow_all_comment0" value="0"<?php if (! $this->_rootref['S_ALLOW_ALL_COMMENT']) {  ?> checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></label>
		</dd>
	</dl>
	<dl>
		<dt><label for="allow_friend_only0"><?php echo ((isset($this->_rootref['L_ALLOW_FRIEND_ONLY'])) ? $this->_rootref['L_ALLOW_FRIEND_ONLY'] : ((isset($user->lang['ALLOW_FRIEND_ONLY'])) ? $user->lang['ALLOW_FRIEND_ONLY'] : '{ ALLOW_FRIEND_ONLY }')); ?>:</label><br /><span><?php echo ((isset($this->_rootref['L_ALLOW_FRIEND_ONLY_EXPLAIN'])) ? $this->_rootref['L_ALLOW_FRIEND_ONLY_EXPLAIN'] : ((isset($user->lang['ALLOW_FRIEND_ONLY_EXPLAIN'])) ? $user->lang['ALLOW_FRIEND_ONLY_EXPLAIN'] : '{ ALLOW_FRIEND_ONLY_EXPLAIN }')); ?></span></dt>
		<dd>
			<label for="allow_friend_only1"><input type="radio" name="allow_friend_only" id="allow_friend_only1" value="1"<?php if ($this->_rootref['S_ALLOW_FRIEND_ONLY']) {  ?> checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></label> 
			<label for="allow_friend_only0"><input type="radio" name="allow_friend_only" id="allow_friend_only0" value="0"<?php if (! $this->_rootref['S_ALLOW_FRIEND_ONLY']) {  ?> checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></label>
		</dd>
	</dl>

	<dl>
		<dt><label for="allow_friend_view0"><?php echo ((isset($this->_rootref['L_ALLOW_FRIEND_VIEW'])) ? $this->_rootref['L_ALLOW_FRIEND_VIEW'] : ((isset($user->lang['ALLOW_FRIEND_VIEW'])) ? $user->lang['ALLOW_FRIEND_VIEW'] : '{ ALLOW_FRIEND_VIEW }')); ?>:</label<br /><span><?php echo ((isset($this->_rootref['L_ALLOW_FRIEND_VIEW_EXPLAIN'])) ? $this->_rootref['L_ALLOW_FRIEND_VIEW_EXPLAIN'] : ((isset($user->lang['ALLOW_FRIEND_VIEW_EXPLAIN'])) ? $user->lang['ALLOW_FRIEND_VIEW_EXPLAIN'] : '{ ALLOW_FRIEND_VIEW_EXPLAIN }')); ?></span></dt>
		<dd>
			<label for="allow_friend_view1"><input type="radio" name="allow_friend_view" id="allow_friend_view1" value="1"<?php if ($this->_rootref['S_ALLOW_FRIEND_VIEW']) {  ?> checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></label> 
			<label for="allow_friend_view0"><input type="radio" name="allow_friend_view" id="allow_friend_view0" value="0"<?php if (! $this->_rootref['S_ALLOW_FRIEND_VIEW']) {  ?> checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></label>
		</dd>
	</dl>
	<dl>
		<dt><label for="allow_comment_email0"><?php echo ((isset($this->_rootref['L_ALLOW_COMMENT_EMAIL'])) ? $this->_rootref['L_ALLOW_COMMENT_EMAIL'] : ((isset($user->lang['ALLOW_COMMENT_EMAIL'])) ? $user->lang['ALLOW_COMMENT_EMAIL'] : '{ ALLOW_COMMENT_EMAIL }')); ?>:</label><br /><span><?php echo ((isset($this->_rootref['L_ALLOW_COMMENT_EMAIL_EXPLAIN'])) ? $this->_rootref['L_ALLOW_COMMENT_EMAIL_EXPLAIN'] : ((isset($user->lang['ALLOW_COMMENT_EMAIL_EXPLAIN'])) ? $user->lang['ALLOW_COMMENT_EMAIL_EXPLAIN'] : '{ ALLOW_COMMENT_EMAIL_EXPLAIN }')); ?></span></dt>
		<dd>
			<label for="allow_comment_email1"><input type="radio" name="allow_comment_email" id="allow_comment_email1" value="1"<?php if ($this->_rootref['S_ALLOW_COMMENT_EMAIL']) {  ?> checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></label> 
			<label for="allow_comment_email0"><input type="radio" name="allow_comment_email" id="allow_comment_email0" value="0"<?php if (! $this->_rootref['S_ALLOW_COMMENT_EMAIL']) {  ?> checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></label>
		</dd>
	</dl>
	</fieldset>
