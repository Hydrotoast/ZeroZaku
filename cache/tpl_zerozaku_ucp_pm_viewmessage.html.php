...
<div id="post-<?php echo (isset($this->_rootref['MESSAGE_ID'])) ? $this->_rootref['MESSAGE_ID'] : ''; ?>" class="panel clearfix post pm-panel-message pm<?php if ($this->_rootref['S_POST_UNAPPROVED'] || $this->_rootref['S_POST_REPORTED']) {  ?> reported<?php } if ($this->_rootref['S_ONLINE']) {  ?> online<?php } ?>">
	...
	<div class="postmeta">
		<div class="dropdown">
			<span><?php echo (isset($this->_rootref['MESSAGE_AUTHOR_FULL'])) ? $this->_rootref['MESSAGE_AUTHOR_FULL'] : ''; ?> <img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/dropdown_arrow.png" alt="Arrow" /></span>
		...
		<span class="date"><?php echo (isset($this->_rootref['SENT_DATE'])) ? $this->_rootref['SENT_DATE'] : ''; ?></span>
	</div>
	...
	<div class="postbody">
		...
		<p class="author">
			<strong><?php echo ((isset($this->_rootref['L_PM_FROM'])) ? $this->_rootref['L_PM_FROM'] : ((isset($user->lang['PM_FROM'])) ? $user->lang['PM_FROM'] : '{ PM_FROM }')); ?>:</strong> <?php echo (isset($this->_rootref['MESSAGE_AUTHOR_FULL'])) ? $this->_rootref['MESSAGE_AUTHOR_FULL'] : ''; ?>
	...
	<dl class="postprofile" id="profile<?php echo (isset($this->_rootref['MESSAGE_ID'])) ? $this->_rootref['MESSAGE_ID'] : ''; ?>">
		<dt><?php if ($this->_rootref['AUTHOR_AVATAR']) {  ?><a href="<?php echo (isset($this->_rootref['U_MESSAGE_AUTHOR'])) ? $this->_rootref['U_MESSAGE_AUTHOR'] : ''; ?>"><?php echo (isset($this->_rootref['AUTHOR_AVATAR'])) ? $this->_rootref['AUTHOR_AVATAR'] : ''; ?></a><?php } ?></dt>
		
		<dd>&nbsp;</dd>
		<?php if ($this->_rootref['RANK_TITLE'] || $this->_rootref['RANK_IMG']) {  ?><dd><strong><?php echo ((isset($this->_rootref['L_RANK_TITLE'])) ? $this->_rootref['L_RANK_TITLE'] : ((isset($user->lang['RANK_TITLE'])) ? $user->lang['RANK_TITLE'] : '{ RANK_TITLE }')); ?>:</strong> <?php echo (isset($this->_rootref['RANK_TITLE'])) ? $this->_rootref['RANK_TITLE'] : ''; if ($this->_rootref['RANK_TITLE'] && $this->_rootref['RANK_IMG']) {  ?><br /><?php } echo (isset($this->_rootref['RANK_IMG'])) ? $this->_rootref['RANK_IMG'] : ''; ?></dd><?php } ?>
