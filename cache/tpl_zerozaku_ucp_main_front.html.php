...
<?php if (sizeof($this->_tpldata['topicrow'])) {  ?>
	...
	<h3 class="sub"><?php echo ((isset($this->_rootref['L_IMPORTANT_NEWS'])) ? $this->_rootref['L_IMPORTANT_NEWS'] : ((isset($user->lang['IMPORTANT_NEWS'])) ? $user->lang['IMPORTANT_NEWS'] : '{ IMPORTANT_NEWS }')); ?></h3>
...
<?php } if (sizeof($this->_tpldata['reputation_row'])) {  ?>
	...
	<h3 class="sub"><?php echo ((isset($this->_rootref['L_RP_RECENT_POINTS'])) ? $this->_rootref['L_RP_RECENT_POINTS'] : ((isset($user->lang['RP_RECENT_POINTS'])) ? $user->lang['RP_RECENT_POINTS'] : '{ RP_RECENT_POINTS }')); ?></h3>
...
<?php } ?>
	...
	<h3 class="sub"><?php echo ((isset($this->_rootref['L_YOUR_DETAILS'])) ? $this->_rootref['L_YOUR_DETAILS'] : ((isset($user->lang['YOUR_DETAILS'])) ? $user->lang['YOUR_DETAILS'] : '{ YOUR_DETAILS }')); ?></h3>
