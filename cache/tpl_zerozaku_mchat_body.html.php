...
var mChatFile = '<?php echo (isset($this->_rootref['MCHAT_FILE_NAME'])) ? $this->_rootref['MCHAT_FILE_NAME'] : ''; ?>',
	mChatForumRoot = '<?php echo (isset($this->_rootref['ROOT_PATH'])) ? $this->_rootref['ROOT_PATH'] : ''; ?>',
	mChatNoMessageInput = '<?php echo ((isset($this->_rootref['LA_MCHAT_NOMESSAGEINPUT'])) ? $this->_rootref['LA_MCHAT_NOMESSAGEINPUT'] : ((isset($this->_rootref['L_MCHAT_NOMESSAGEINPUT'])) ? addslashes($this->_rootref['L_MCHAT_NOMESSAGEINPUT']) : ((isset($user->lang['MCHAT_NOMESSAGEINPUT'])) ? addslashes($user->lang['MCHAT_NOMESSAGEINPUT']) : '{ MCHAT_NOMESSAGEINPUT }'))); ?>',
	mChatNoMessage = '<?php echo ((isset($this->_rootref['LA_MCHAT_NOMESSAGE'])) ? $this->_rootref['LA_MCHAT_NOMESSAGE'] : ((isset($this->_rootref['L_MCHAT_NOMESSAGE'])) ? addslashes($this->_rootref['L_MCHAT_NOMESSAGE']) : ((isset($user->lang['MCHAT_NOMESSAGE'])) ? addslashes($user->lang['MCHAT_NOMESSAGE']) : '{ MCHAT_NOMESSAGE }'))); ?>',
	mChatEditInfo = '<?php echo ((isset($this->_rootref['LA_MCHAT_EDITINFO'])) ? $this->_rootref['LA_MCHAT_EDITINFO'] : ((isset($this->_rootref['L_MCHAT_EDITINFO'])) ? addslashes($this->_rootref['L_MCHAT_EDITINFO']) : ((isset($user->lang['MCHAT_EDITINFO'])) ? addslashes($user->lang['MCHAT_EDITINFO']) : '{ MCHAT_EDITINFO }'))); ?>',
	mChatNoAccess = '<?php echo ((isset($this->_rootref['LA_MCHAT_NOACCESS'])) ? $this->_rootref['LA_MCHAT_NOACCESS'] : ((isset($this->_rootref['L_MCHAT_NOACCESS'])) ? addslashes($this->_rootref['L_MCHAT_NOACCESS']) : ((isset($user->lang['MCHAT_NOACCESS'])) ? addslashes($user->lang['MCHAT_NOACCESS']) : '{ MCHAT_NOACCESS }'))); ?>',
	mChatFlood = '<?php echo ((isset($this->_rootref['LA_MCHAT_FLOOD'])) ? $this->_rootref['LA_MCHAT_FLOOD'] : ((isset($this->_rootref['L_MCHAT_FLOOD'])) ? addslashes($this->_rootref['L_MCHAT_FLOOD']) : ((isset($user->lang['MCHAT_FLOOD'])) ? addslashes($user->lang['MCHAT_FLOOD']) : '{ MCHAT_FLOOD }'))); ?>',
	mChatDelConfirm = '<?php echo ((isset($this->_rootref['LA_MCHAT_DELCONFIRM'])) ? $this->_rootref['LA_MCHAT_DELCONFIRM'] : ((isset($this->_rootref['L_MCHAT_DELCONFIRM'])) ? addslashes($this->_rootref['L_MCHAT_DELCONFIRM']) : ((isset($user->lang['MCHAT_DELCONFIRM'])) ? addslashes($user->lang['MCHAT_DELCONFIRM']) : '{ MCHAT_DELCONFIRM }'))); ?>';
<?php if ($this->_rootref['MCHAT_CUSTOM_PAGE_WHOIS'] && $this->_rootref['MCHAT_CUSTOM_PAGE']) {  ?>
var mChatCustomWhois = true,
	mChatWhoisRefresh = '<?php echo (isset($this->_rootref['MCHAT_WHOIS_REFRESH'])) ? $this->_rootref['MCHAT_WHOIS_REFRESH'] : ''; ?>';
<?php } else { ?>
var mChatCustomWhois = false,
	mChatWhoisRefresh = false;
<?php } if ($this->_rootref['MCHAT_ARCHIVE_MODE']) {  ?>
var mChatArchiveMode = true,
	mChatRefresh = '<?php echo (isset($this->_rootref['MCHAT_REFRESH_JS'])) ? $this->_rootref['MCHAT_REFRESH_JS'] : ''; ?>';
<?php } else { ?>
...
// ]]>
		...
		<script type="text/javascript" src="<?php echo (isset($this->_rootref['T_TEMPLATE_PATH'])) ? $this->_rootref['T_TEMPLATE_PATH'] : ''; ?>/scripts/mchat.ajax.mini.js"></script>
		<?php } } else { ?>
