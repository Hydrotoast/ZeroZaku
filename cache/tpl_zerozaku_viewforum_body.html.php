<?php if (!defined('IN_PHPBB')) exit; $this->_tpldata['DEFINE']['.']['CA_PAGE'] = 'viewforum'; $this->_tpl_include('overall_header.html'); if ($this->_rootref['FORUM_DESC'] || $this->_rootref['FORUM_SEO_DESC']) {  ?>
	...
	<div class="panel smooth info <?php if ($this->_rootref['FORUM_SEO_DESC']) {  ?>seo<?php } ?>">
			<?php if ($this->_rootref['FORUM_SEO_DESC']) {  ?><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/tag_blue.png" alt="<?php echo (isset($this->_rootref['FORUM_SEO_KEY'])) ? $this->_rootref['FORUM_SEO_KEY'] : ''; ?>" /><h3 class="infotitle"><?php echo (isset($this->_rootref['FORUM_SEO_KEY'])) ? $this->_rootref['FORUM_SEO_KEY'] : ''; ?></h3><p><span><?php echo (isset($this->_rootref['FORUM_SEO_DESC'])) ? $this->_rootref['FORUM_SEO_DESC'] : ''; ?></span></p>
