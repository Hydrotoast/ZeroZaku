<?php if (!defined('IN_PHPBB')) exit; ?><div class="panel bg3" id="poll-panel">
	...
	<?php if ($this->_rootref['S_SHOW_POLL_BOX']) {  if ($this->_rootref['S_POLL_DELETE']) {  ?>
		...
		<?php } ?>
			...
			<dl>
				<dt><label for="poll_show_voters"><?php echo ((isset($this->_rootref['L_POLL_SHOW_VOTERS'])) ? $this->_rootref['L_POLL_SHOW_VOTERS'] : ((isset($user->lang['POLL_SHOW_VOTERS'])) ? $user->lang['POLL_SHOW_VOTERS'] : '{ POLL_SHOW_VOTERS }')); ?>:</label></dt>
				<dd><label for="poll_show_voters"><input type="checkbox" id="poll_show_voters" name="poll_show_voters"<?php echo (isset($this->_rootref['SHOW_VOTERS_CHECKED'])) ? $this->_rootref['SHOW_VOTERS_CHECKED'] : ''; ?> /> <?php echo ((isset($this->_rootref['L_POLL_SHOW_VOTERS_EXPLAIN'])) ? $this->_rootref['L_POLL_SHOW_VOTERS_EXPLAIN'] : ((isset($user->lang['POLL_SHOW_VOTERS_EXPLAIN'])) ? $user->lang['POLL_SHOW_VOTERS_EXPLAIN'] : '{ POLL_SHOW_VOTERS_EXPLAIN }')); ?></label></dd>
			</dl>
