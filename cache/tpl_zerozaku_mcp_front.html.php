...
<?php if ($this->_rootref['S_SHOW_UNAPPROVED']) {  ?>
	...
	<div class="panel">
		...
		<h3 class="sub"><?php echo ((isset($this->_rootref['L_LATEST_UNAPPROVED'])) ? $this->_rootref['L_LATEST_UNAPPROVED'] : ((isset($user->lang['LATEST_UNAPPROVED'])) ? $user->lang['LATEST_UNAPPROVED'] : '{ LATEST_UNAPPROVED }')); ?></h3>
...
<?php } if ($this->_rootref['S_SHOW_REPORTS']) {  ?>
	...
	<div class="panel">
		...
		<h3 class="sub"><?php echo ((isset($this->_rootref['L_LATEST_REPORTED'])) ? $this->_rootref['L_LATEST_REPORTED'] : ((isset($user->lang['LATEST_REPORTED'])) ? $user->lang['LATEST_REPORTED'] : '{ LATEST_REPORTED }')); ?></h3>
		<?php if ($this->_rootref['S_HAS_REPORTS']) {  ?><p><?php echo ((isset($this->_rootref['L_REPORTS_TOTAL'])) ? $this->_rootref['L_REPORTS_TOTAL'] : ((isset($user->lang['REPORTS_TOTAL'])) ? $user->lang['REPORTS_TOTAL'] : '{ REPORTS_TOTAL }')); ?></p><?php } if (sizeof($this->_tpldata['report'])) {  ?>
			...
			<ul class="topiclist">
				<li class="header">
					<dl class="meta">
						<dt class="no-icon"><div class="inner"><?php echo ((isset($this->_rootref['L_VIEW_DETAILS'])) ? $this->_rootref['L_VIEW_DETAILS'] : ((isset($user->lang['VIEW_DETAILS'])) ? $user->lang['VIEW_DETAILS'] : '{ VIEW_DETAILS }')); ?></div></dt>
						<dd class="moderation"><div class="inner"><?php echo ((isset($this->_rootref['L_REPORTER'])) ? $this->_rootref['L_REPORTER'] : ((isset($user->lang['REPORTER'])) ? $user->lang['REPORTER'] : '{ REPORTER }')); ?> &amp; <?php echo ((isset($this->_rootref['L_FORUM'])) ? $this->_rootref['L_FORUM'] : ((isset($user->lang['FORUM'])) ? $user->lang['FORUM'] : '{ FORUM }')); ?></div></dd>
					</dl>
				</li>
			</ul>
			<ul class="topiclist cplist">
		...
		<?php } if ($this->_rootref['S_SHOW_PM_REPORTS']) {  ?>
			...
			<div class="panel">
				...
				<h3 class="sub"><?php echo ((isset($this->_rootref['L_LATEST_REPORTED_PMS'])) ? $this->_rootref['L_LATEST_REPORTED_PMS'] : ((isset($user->lang['LATEST_REPORTED_PMS'])) ? $user->lang['LATEST_REPORTED_PMS'] : '{ LATEST_REPORTED_PMS }')); ?></h3>
				<?php if ($this->_rootref['S_HAS_PM_REPORTS']) {  ?><p><?php echo ((isset($this->_rootref['L_PM_REPORTS_TOTAL'])) ? $this->_rootref['L_PM_REPORTS_TOTAL'] : ((isset($user->lang['PM_REPORTS_TOTAL'])) ? $user->lang['PM_REPORTS_TOTAL'] : '{ PM_REPORTS_TOTAL }')); ?></p><?php } if (sizeof($this->_tpldata['pm_report'])) {  ?>
					...
					<ul class="topiclist">
						<li class="header">
							<dl class="meta">
								<dt class="no-icon"><div class="inner"><?php echo ((isset($this->_rootref['L_VIEW_DETAILS'])) ? $this->_rootref['L_VIEW_DETAILS'] : ((isset($user->lang['VIEW_DETAILS'])) ? $user->lang['VIEW_DETAILS'] : '{ VIEW_DETAILS }')); ?></div></dt>
								<dd class="moderation"><div class="inner"><?php echo ((isset($this->_rootref['L_REPORTER'])) ? $this->_rootref['L_REPORTER'] : ((isset($user->lang['REPORTER'])) ? $user->lang['REPORTER'] : '{ REPORTER }')); ?></div></dd>
							</dl>
						</li>
					</ul>
					<ul class="topiclist cplist">
...
<?php } if ($this->_rootref['S_SHOW_LOGS']) {  ?>
	...
	<div class="panel">
		...
		<h3 class="sub"><?php echo ((isset($this->_rootref['L_LATEST_LOGS'])) ? $this->_rootref['L_LATEST_LOGS'] : ((isset($user->lang['LATEST_LOGS'])) ? $user->lang['LATEST_LOGS'] : '{ LATEST_LOGS }')); ?></h3>
