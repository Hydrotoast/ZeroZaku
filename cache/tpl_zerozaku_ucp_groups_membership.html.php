...
<div class="panel">
	...
	<?php $this->_tpldata['DEFINE']['.']['SHOW_BUTTONS'] = 0; if (sizeof($this->_tpldata['leader'])) {  ?>
		...
		<ul class="topiclist">
			<li class="header">
				<dl class="meta">
					<dt class="no-icon"><div class="inner"><?php echo ((isset($this->_rootref['L_GROUP_LEADER'])) ? $this->_rootref['L_GROUP_LEADER'] : ((isset($user->lang['GROUP_LEADER'])) ? $user->lang['GROUP_LEADER'] : '{ GROUP_LEADER }')); ?></div></dt>
					<dd class="mark"><div class="inner"><?php echo ((isset($this->_rootref['L_SELECT'])) ? $this->_rootref['L_SELECT'] : ((isset($user->lang['SELECT'])) ? $user->lang['SELECT'] : '{ SELECT }')); ?></div></dd>
				</dl>
			</li>
		</ul>
		...
		<li class="row<?php if (($_leader_val['S_ROW_COUNT'] & 1)  ) {  ?> bg1<?php } else { ?> bg2<?php } ?>">
			<dl>
				...
				<dd class="mark"><div class="inner"><input type="radio" name="selected" value="<?php echo $_leader_val['GROUP_ID']; ?>" <?php if ($_leader_val['GROUP_SPECIAL']) {  ?>disabled="disabled"<?php } ?> /></div></dd>
			</dl>
		</li>
		<?php }} ?>
	...
	<?php } if (sizeof($this->_tpldata['member'])) {  ?>
		...
		<ul class="topiclist">
			<li class="header">
				<dl class="meta">
					<dt class="no-icon"><div class="inner"><?php echo ((isset($this->_rootref['L_GROUP_MEMBER'])) ? $this->_rootref['L_GROUP_MEMBER'] : ((isset($user->lang['GROUP_MEMBER'])) ? $user->lang['GROUP_MEMBER'] : '{ GROUP_MEMBER }')); ?></div></dt>
					<dd class="mark"><div class="inner"><?php echo ((isset($this->_rootref['L_SELECT'])) ? $this->_rootref['L_SELECT'] : ((isset($user->lang['SELECT'])) ? $user->lang['SELECT'] : '{ SELECT }')); ?></div></dd>
				</dl>
			</li>
		</ul>
		...
		<li class="row<?php if (($_member_val['S_ROW_COUNT'] & 1)  ) {  ?> bg1<?php } else { ?> bg2<?php } ?>">
			<dl>
				...
				<dd class="mark"><div class="inner"><input type="radio" name="selected" value="<?php echo $_member_val['GROUP_ID']; ?>" <?php if ($_member_val['GROUP_SPECIAL']) {  ?>disabled="disabled"<?php } ?> /></div></dd>
			</dl>
		</li>
		<?php }} ?>
...
<div class="panel">
	<div class="inner">
		<ul class="topiclist">
			<li class="header">
				<dl class="meta">
					<dt class="no-icon"><div class="inner"><?php echo ((isset($this->_rootref['L_GROUP_PENDING'])) ? $this->_rootref['L_GROUP_PENDING'] : ((isset($user->lang['GROUP_PENDING'])) ? $user->lang['GROUP_PENDING'] : '{ GROUP_PENDING }')); ?></div></dt>
					<dd class="mark"><div class="inner"><?php echo ((isset($this->_rootref['L_SELECT'])) ? $this->_rootref['L_SELECT'] : ((isset($user->lang['SELECT'])) ? $user->lang['SELECT'] : '{ SELECT }')); ?></div></dd>
				</dl>
			</li>
		</ul>
		...
		<li class="row<?php if (($_pending_val['S_ROW_COUNT'] & 1)  ) {  ?> bg1<?php } else { ?> bg2<?php } ?>">
			<dl>
				...
				<dd class="mark"><div class="inner"><input type="radio" name="selected" value="<?php echo $_pending_val['GROUP_ID']; ?>" <?php if ($_pending_val['GROUP_SPECIAL']) {  ?>disabled="diabled"<?php } ?> /></div></dd>
			</dl>
		</li>
		<?php }} ?>
...
<div class="panel">
	<div class="inner">
		<ul class="topiclist">
			<li class="header">
				<dl class="meta">
					<dt class="no-icon"><div class="inner"><?php echo ((isset($this->_rootref['L_GROUP_NONMEMBER'])) ? $this->_rootref['L_GROUP_NONMEMBER'] : ((isset($user->lang['GROUP_NONMEMBER'])) ? $user->lang['GROUP_NONMEMBER'] : '{ GROUP_NONMEMBER }')); ?></div></dt>
					<dd class="mark"><div class="inner"><?php echo ((isset($this->_rootref['L_SELECT'])) ? $this->_rootref['L_SELECT'] : ((isset($user->lang['SELECT'])) ? $user->lang['SELECT'] : '{ SELECT }')); ?></div></dd>
				</dl>
			</li>
		</ul>
		...
		<li class="row<?php if (($_nonmember_val['S_ROW_COUNT'] & 1)  ) {  ?> bg1<?php } else { ?> bg2<?php } ?>">
			<dl>
				...
				<dd class="mark"><div class="inner"><input type="radio" name="selected" value="<?php echo $_nonmember_val['GROUP_ID']; ?>" <?php if (! $_nonmember_val['S_CAN_JOIN']) {  ?>disabled="disabled"<?php } ?> /></div></dd>
			</dl>
		</li>
		<?php }} ?>
