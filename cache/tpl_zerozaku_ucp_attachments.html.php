...
<div class="panel">
	...
	<?php if (sizeof($this->_tpldata['attachrow'])) {  ?>
		...
		<ul class="topiclist">
			<li class="header">
				<dl class="meta">
					<dt class="no-icon" style="width: 40%"><div class="inner"><a href="<?php echo (isset($this->_rootref['U_SORT_FILENAME'])) ? $this->_rootref['U_SORT_FILENAME'] : ''; ?>"><?php echo ((isset($this->_rootref['L_FILENAME'])) ? $this->_rootref['L_FILENAME'] : ((isset($user->lang['FILENAME'])) ? $user->lang['FILENAME'] : '{ FILENAME }')); ?></a></div></dt>
					...
					<dd class="time"><div class="inner"><span><a href="<?php echo (isset($this->_rootref['U_SORT_POST_TIME'])) ? $this->_rootref['U_SORT_POST_TIME'] : ''; ?>"><?php echo ((isset($this->_rootref['L_POST_TIME'])) ? $this->_rootref['L_POST_TIME'] : ((isset($user->lang['POST_TIME'])) ? $user->lang['POST_TIME'] : '{ POST_TIME }')); ?></a></span></div></dd>
					<dd class="extra"><div class="inner"><a href="<?php echo (isset($this->_rootref['U_SORT_DOWNLOADS'])) ? $this->_rootref['U_SORT_DOWNLOADS'] : ''; ?>"><?php echo ((isset($this->_rootref['L_DOWNLOADS'])) ? $this->_rootref['L_DOWNLOADS'] : ((isset($user->lang['DOWNLOADS'])) ? $user->lang['DOWNLOADS'] : '{ DOWNLOADS }')); ?></a></div></dd>
				</dl>
			</li>
		</ul>
		...
		<li class="row<?php if (($_attachrow_val['S_ROW_COUNT'] & 1)  ) {  ?> bg1<?php } else { ?> bg2<?php } ?>">
			<dl>
				<dt class="no-icon" style="width: 40%"><div class="inner"><a href="<?php echo $_attachrow_val['U_VIEW_ATTACHMENT']; ?>" class="topictitle"><?php echo $_attachrow_val['FILENAME']; ?></a> (<?php echo $_attachrow_val['SIZE']; ?>)<br />
					<?php if ($_attachrow_val['S_IN_MESSAGE']) {  echo ((isset($this->_rootref['L_PM'])) ? $this->_rootref['L_PM'] : ((isset($user->lang['PM'])) ? $user->lang['PM'] : '{ PM }')); ?>: <?php } else { echo ((isset($this->_rootref['L_TOPIC'])) ? $this->_rootref['L_TOPIC'] : ((isset($user->lang['TOPIC'])) ? $user->lang['TOPIC'] : '{ TOPIC }')); ?>: <?php } ?><a href="<?php echo $_attachrow_val['U_VIEW_TOPIC']; ?>"><?php echo $_attachrow_val['TOPIC_TITLE']; ?></a></div></dt>
				<dd class="mark"><div class="inner"><input type="checkbox" name="attachment[<?php echo $_attachrow_val['ATTACH_ID']; ?>]" value="1" /></div></dd>
				<dd class="time"><div class="inner"><span><?php echo $_attachrow_val['POST_TIME']; ?></span></div></dd>
				<dd class="extra"><div class="inner"><?php echo $_attachrow_val['DOWNLOAD_COUNT']; ?></div></dd>
			</dl>
		</li>
		<?php }} ?>
