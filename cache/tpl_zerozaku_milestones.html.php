<?php if (!defined('IN_PHPBB')) exit; echo (isset($this->_tpldata['DEFINE']['.']['TBL_BLOCK_H_L'])) ? $this->_tpldata['DEFINE']['.']['TBL_BLOCK_H_L'] : ''; ?><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/globe.png" alt=""/>&nbsp;<?php echo ((isset($this->_rootref['L_MILESTONE_HISTORY'])) ? $this->_rootref['L_MILESTONE_HISTORY'] : ((isset($user->lang['MILESTONE_HISTORY'])) ? $user->lang['MILESTONE_HISTORY'] : '{ MILESTONE_HISTORY }')); echo (isset($this->_tpldata['DEFINE']['.']['TBL_BLOCK_H_R'])) ? $this->_tpldata['DEFINE']['.']['TBL_BLOCK_H_R'] : ''; ?>
