...
<div class="leaderboard">
	...
	<?php $_top_poster_count = (isset($this->_tpldata['top_poster'])) ? sizeof($this->_tpldata['top_poster']) : 0;if ($_top_poster_count) {for ($_top_poster_i = 0; $_top_poster_i < $_top_poster_count; ++$_top_poster_i){$_top_poster_val = &$this->_tpldata['top_poster'][$_top_poster_i]; ?>
		<li><?php if ($_top_poster_val['AVATAR']) {  echo $_top_poster_val['AVATAR']; } else { ?><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/no-avatar.png" height="40px" width="40px" alt="Default Avatar" /><?php } ?> 
			<div><?php echo $_top_poster_val['USERNAME_FULL']; ?>
				<br /><a href="<?php echo $_top_poster_val['S_SEARCH_ACTION']; ?>" class="posts"><?php echo $_top_poster_val['POSTER_POSTS']; ?></a> <?php echo ((isset($this->_rootref['L_POSTS'])) ? $this->_rootref['L_POSTS'] : ((isset($user->lang['POSTS'])) ? $user->lang['POSTS'] : '{ POSTS }')); ?>
			</div>
		</li>
	<?php }} ?>
	</ul>
