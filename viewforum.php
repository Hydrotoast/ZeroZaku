...
// Build the ad
$ads_enabled = generate_ad($forum_id);
...
if ($mark_read == 'topics')
{
	...
	trigger_error($user->lang['TOPICS_MARKED'] . '<br />' . sprintf($user->lang['RETURN_FORUM'], '<a href="' . $redirect_url . '">', '</a>'));
}
...
if (sizeof($topic_list))
{
	...
	foreach ($topic_list as $topic_id)
	{
		...
		$template->assign_block_vars('topicrow', array(
			...
			'S_POST_NORMAL'			=> ($row['topic_type'] == POST_NORMAL) ? true : false,
